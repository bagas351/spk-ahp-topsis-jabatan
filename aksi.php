...
elseif($mod=='alternatif_tambah'){
    ...
    if($kode=='' || $nama=='')
        ...
        $db->query("UPDATE tb_alternatif SET nama_alternatif='$nama', Jabatan='$Jabatan' WHERE kode_alternatif='$_GET[ID]'");
        redirect_js("index.php?m=alternatif");
    }
...
elseif($mod=='crips_tambah'){
    ...
    if($nilai=='' || $Jabatan=='')
        ...
        $db->query("UPDATE tb_crips SET nilai='$nilai', Jabatan='$Jabatan' WHERE kode_crips='$_GET[ID]'");
        redirect_js("index.php?m=crips&kode_kriteria=$_GET[kode_kriteria]");
    }   
